  ...
  <transition name="fade">
    <div class="popup-overlay" v-if="visible">
      <div class="popup-glassy">
        <h3 class="popup-title">Create Room</h3>
        <form @submit.prevent="submitRoom" class="popup-form">
          <label for="roomName" class="popup-label">Room Name</label>
          <input
            id="roomName"
            v-model="roomName"
            type="text"
          ...
          <div class="popup-actions">
            <button type="submit" class="start-vote-btn">Create</button>
